...
export class UserController {
  ...
  async signup(
    ...
    //TODO: change signUp to signup or another method name in userService to match controller method.
  ...
  async softDeleteUser(
    ...
    return this.userService.softDeleteUser(currentUser, id);
  }
  ...
  async updateSingleUser(
    ...
    return this.userService.updateSingleUser(user, id, userData);
  }
}
